    ...
    var body: some View {
        ZStack {
            ...
            TabView(selection: $selectedTab) {
                ...
                .tabItem {
                    Label("Flowchart", systemImage: "map.fill")
                }
                .tag(0)
                
                // Tab 2: References
                ReferencesScreen(projectId: projectId, viewModel: viewModel)
                    .tabItem {
                        Label("References", systemImage: "person.2.square.stack.fill")
                    }
                    .tag(1)
            }
